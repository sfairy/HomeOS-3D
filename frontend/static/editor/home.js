...
import { showDisplayPairingQr } from "../display/display-pairing-qr.js?v=2609251920";
...
} from "../renderer/core/renderer.js?v=2609251920";
...
} from "../templates/component-templates.js?v=2609251920";
import { clone, newId, roundField, normalizedFontWeight } from "./editor-utils.js?v=2609251920";
import { clampNumber } from "../utils/numbers.js?v=2609251920";
import { AIRFLOW_OTHER_COLOR } from "../utils/airflow-colors.js?v=2609251920";
// 数字输入的步进实现（含 step 非法时的兜底步长）只有一份，策略参数见该模块头部。

import { mdiIconUrl } from "../utils/icon-url.js?v=2609251920";
import { formatZhDateTime } from "../utils/datetime.js?v=2609251920";
import { entityDomainFromId, entityDomainOf } from "../utils/entities.js?v=2609251920";
...
import { positionFloatingMenu } from "../shared/menu-positioning.js?v=2609251920";
import {
  packPopupModules,
  popupLayoutColumns,
  popupLayoutMetrics
} from "../shared/popup-layout.js?v=2609251920";
import {
  countComponentsOutsideCanvas,
  resizeDashboardDocument
} from "./dashboard-resize.js?v=2609251920";
// 导图底图分辨率必须与控件宽高比一致，否则底图在预览里会被拉伸、位置对不上（见模块注释）。
import { floorplanAutoDiagramExportResolution } from "./floorplan-auto-diagram-layout.js?v=2609251920";
import {
  copyComponentsAcrossDocuments,
  copyComponentTargets,
  copyComponentsToTarget
} from "./component-page-copy.js?v=2609251920";
import {
...
} from "../shared/related-entities.js?v=2609251920";

import { createButtonSound } from "../shared/sound-effects.js?v=2609251920";
import {
  deferHiddenEditorDialogs,
  installSettingsDialogBackdropGuard
} from "./editor-dialogs.js?v=2609251920";
import { confirmAction } from "../shared/ui-confirm.js?v=2609251920";
...
import { licenseMessage } from "../auth/license-recovery.js?v=2609251920";
import { createEditorPickerElements } from "./picker/editor-picker-elements.js?v=2609251920";
import {
  EDITOR_PICKER_PAGE_SIZES,
  editorEntityPickerInitialPage,
  editorEntityPickerPage
} from "./picker/editor-picker-pagination.js?v=2609251920";
import { createEditorPickerQueries } from "./picker/editor-picker-queries.js?v=2609251920";
import { createEditorAssetMatcher } from "./picker/editor-asset-queries.js?v=2609251920";

import { createInteraction3dEditorPickers } from "../bridge/editor-pickers.js?v=2609251920";
import { createEditorAssetToolbar } from "./picker/editor-asset-toolbar.js?v=2609251920";
import {
  ACTION_TYPES,
...
} from "../shared/action-rules.js?v=2609251920";
import {
  componentDirectLocation,
  findComponent,
  findComponentInItems,
  findComponentLocation
} from "./component-tree.js?v=2609251920";
import {
...
} from "./editor-component-collections.js?v=2609251920";
import {
  ...
  setInspectorToggle
} from "./editor-basic-inspectors.js?v=2609251920";
import {
  ...
  uniquePagePath
} from "./editor-document-management.js?v=2609251920";
import {
  ...
  recoveryStorageKey
} from "./editor-history.js?v=2609251920";
import {
  DEFAULT_BASE_LIGHTING,
  normalizeBaseLighting
} from "../3d-studio/loaders/studio-normalization.js?v=2609251920";
import { createLicenseCard } from "./license-card.js?v=2609251920";
import {
  guardInteraction3dChanges,
  renderInteraction3dThumbnail,
  updateInteraction3dCard,
  renderInteraction3dInspector
} from "../bridge/editor.js?v=2609251920";
import { createPropertyDescriptors } from "./home/property-descriptors.js?v=2609251920";
import { createStyleApplyDialogs } from "./home/style-apply.js?v=2609251920";
import { createEntityOptions } from "./home/entity-options.js?v=2609251920";
import { createPickers } from "./home/pickers.js?v=2609251920";
import { createFormWidgets } from "./home/form-widgets.js?v=2609251920";
import { createColorPicker } from "./home/color-picker.js?v=2609251920";
import { createSectionRegistry } from "./home/sections.js?v=2609251920";
