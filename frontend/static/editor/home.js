...
import { showDisplayPairingQr } from "../display/display-pairing-qr.js?v=2609251754";
...
} from "../renderer/core/renderer.js?v=2609251754";
...
} from "../templates/component-templates.js?v=2609251754";
import { clone, newId, roundField, normalizedFontWeight } from "./editor-utils.js?v=2609251754";
...
import { formatZhDateTime } from "../utils/datetime.js?v=2609251754";
import { entityDomainFromId, entityDomainOf } from "../utils/entities.js?v=2609251754";
...
import { positionFloatingMenu } from "../shared/menu-positioning.js?v=2609251754";
import {
  packPopupModules,
  popupLayoutColumns,
  popupLayoutMetrics
} from "../shared/popup-layout.js?v=2609251754";
import {
  countComponentsOutsideCanvas,
  resizeDashboardDocument
} from "./dashboard-resize.js?v=2609251754";
// 导图底图分辨率必须与控件宽高比一致，否则底图在预览里会被拉伸、位置对不上（见模块注释）。
import { floorplanAutoDiagramExportResolution } from "./floorplan-auto-diagram-layout.js?v=2609251754";
import {
  copyComponentsAcrossDocuments,
  copyComponentTargets,
  copyComponentsToTarget
} from "./component-page-copy.js?v=2609251754";
import {
...
} from "../shared/related-entities.js?v=2609251754";

import { createButtonSound } from "../shared/sound-effects.js?v=2609251754";
import {
  deferHiddenEditorDialogs,
  installSettingsDialogBackdropGuard
} from "./editor-dialogs.js?v=2609251754";
import { confirmAction } from "../shared/ui-confirm.js?v=2609251754";
...
import { licenseMessage } from "../auth/license-recovery.js?v=2609251754";
import { createEditorPickerElements } from "./picker/editor-picker-elements.js?v=2609251754";
import {
  EDITOR_PICKER_PAGE_SIZES,
  editorEntityPickerInitialPage,
  editorEntityPickerPage
} from "./picker/editor-picker-pagination.js?v=2609251754";
import { createEditorPickerQueries } from "./picker/editor-picker-queries.js?v=2609251754";
import { createEditorAssetMatcher } from "./picker/editor-asset-queries.js?v=2609251754";

import { createInteraction3dEditorPickers } from "../bridge/editor-pickers.js?v=2609251754";
import { createEditorAssetToolbar } from "./picker/editor-asset-toolbar.js?v=2609251754";
import {
  ACTION_TYPES,
...
} from "../shared/action-rules.js?v=2609251754";
import {
  componentDirectLocation,
  findComponent,
  findComponentInItems,
  findComponentLocation
} from "./component-tree.js?v=2609251754";
import {
...
} from "./editor-component-collections.js?v=2609251754";
import {
  ...
  setInspectorToggle
} from "./editor-basic-inspectors.js?v=2609251754";
import {
  ...
  uniquePagePath
} from "./editor-document-management.js?v=2609251754";
import {
  ...
  recoveryStorageKey
} from "./editor-history.js?v=2609251754";
import {
  DEFAULT_BASE_LIGHTING,
  normalizeBaseLighting
} from "../3d-studio/loaders/studio-normalization.js?v=2609251754";
import { createLicenseCard } from "./license-card.js?v=2609251754";
import {
  guardInteraction3dChanges,
  renderInteraction3dThumbnail,
  updateInteraction3dCard,
  renderInteraction3dInspector
} from "../bridge/editor.js?v=2609251754";
import { createPropertyDescriptors } from "./home/property-descriptors.js?v=2609251754";
import { createStyleApplyDialogs } from "./home/style-apply.js?v=2609251754";
import { createEntityOptions } from "./home/entity-options.js?v=2609251754";
import { createPickers } from "./home/pickers.js?v=2609251754";
import { createFormWidgets } from "./home/form-widgets.js?v=2609251754";
import { createColorPicker } from "./home/color-picker.js?v=2609251754";
import { createSectionRegistry } from "./home/sections.js?v=2609251754";
