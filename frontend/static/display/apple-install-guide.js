 ...
 */
import { needsAppleInstallGuide as shouldShowInstallGuide } from "../auth/pairing-link.js?v=2609262312";
...
if (
  ...
  ((guideDialog.className = "apple-install-dialog"),
    ...
    <img class="apple-install-icon" src="/static/assets/icons/homeos-icon-180-h5.png?v=2609262312" alt="">
