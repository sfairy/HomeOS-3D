 ...
 */
import { resolvePageBehavior } from "./page-behavior.js?v=20260918175732";
import {
  performanceWarnings,
  confirmPerformanceWarning
} from "./performance-warning.js?v=20260918175732";
import { normalizeGroundReflection } from "./reflection-settings.js?v=20260918175732";
import {
  requestInteraction3dAccess,
  getInteraction3dEditorView,
  waitInteraction3dEditorView,
  cancelOtherInteraction3dViews
} from "./bridge.js?v=20260918175732";
import {
  createInteraction3dCover,
  updateInteraction3dCoverMessage
} from "./cover.js?v=20260918175732";
...
} from "./definition.js?v=20260918175732";
/**
  ...
  planRenderButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openInteraction3dAppearanceEditor: openAppearanceEditor } =
        await import("/api/v1/modules/interaction3d/config-editor.js?v=20260918175732");
  ...
  configureSecurityButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openSecurityEditor: openSecurityEditor } =
        await import("/api/v1/modules/interaction3d/security-editor.js?v=20260918175732");
