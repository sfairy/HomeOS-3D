 ...
 */
import { resolvePageBehavior } from "./page-behavior.js?v=20260918202529";
import {
  performanceWarnings,
  confirmPerformanceWarning
} from "./performance-warning.js?v=20260918202529";
import { normalizeGroundReflection } from "./reflection-settings.js?v=20260918202529";
import {
  requestInteraction3dAccess,
  getInteraction3dEditorView,
  waitInteraction3dEditorView,
  cancelOtherInteraction3dViews
} from "./bridge.js?v=20260918202529";
import {
  createInteraction3dCover,
  updateInteraction3dCoverMessage
} from "./cover.js?v=20260918202529";
...
} from "./definition.js?v=20260918202529";
/**
  ...
  planRenderButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openInteraction3dAppearanceEditor: openAppearanceEditor } =
        await import("/api/v1/modules/interaction3d/config-editor.js?v=20260918202529");
  ...
  configureSecurityButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openSecurityEditor: openSecurityEditor } =
        await import("/api/v1/modules/interaction3d/security-editor.js?v=20260918202529");
