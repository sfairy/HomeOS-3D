 ...
 */
import { coverComponentIsDream } from "../core/registry/cover-state.js?v=2609231046";
import { entityMetadataIsAvailable } from "../core/entity-metadata.js?v=2609231046";
...
import { COVER_POSITION_EPSILON_PERCENT } from "../../utils/cover-features.js?v=2609231046";
...
} from "./cover-direction.js?v=2609231046";
/**
 * 通用「实体是否处于活动态」判定。
 */
