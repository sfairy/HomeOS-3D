 ...
 */
import { coverComponentIsDream } from "../core/registry/cover-state.js?v=2609252210";
import { entityMetadataIsAvailable } from "../core/entity-metadata.js?v=2609252210";
...
import { COVER_POSITION_EPSILON_PERCENT } from "../../utils/cover-features.js?v=2609252210";
...
} from "./cover-direction.js?v=2609252210";
/**
 * 通用「实体是否处于活动态」判定。
 */
