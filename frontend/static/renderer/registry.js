...
import { clampCoercedNumber, clampNumber } from "../utils/numbers.js?v=20260919135340";
import {
  climateDefaultIcon,
  climateEffectMode,
  climateIsPoweredOn,
...
import { entityPowerIsOn } from "./entity-power.js?v=20260919135340";
import { lightRealtimeCapabilities } from "./light-runtime.js?v=20260919135340";
import { renderInteraction3d } from "../modules/interaction3d/bridge.js?v=20260919135340";
// 状态条目归一统一走 utils/state-entry.js。本文件原先自带一份同内容实现，
// 而 vacuum-runtime.js / presence-runtime.js 各有一份同内容但换了名字的副本 —— 现在只有一份。
import { resolveStateEntry } from "../utils/state-entry.js?v=20260919135340";
...
// 版本戳用于给 /assets/builtin/ 的 URL 加 ?v=20260919135340
...
} from "./light-statistics-runtime.js?v=20260919135340";
import {
...
} from "./line-chart-runtime.js?v=20260919135340";
import {
  doorWindowPerspectiveCorners,
  doorWindowPerspectiveMatrix
} from "./door-window-runtime.js?v=20260919135340";
import {
  automaticThresholds,
  meteoconUrl,
  ...
  thresholdColor,
  weatherVisual
} from "./weather-chart-runtime.js?v=20260919135340";
import {
  formatLocalDate,
  formatLocalTime,
  formatLunarDate
} from "./date-time-runtime.js?v=20260919135340";
...
} from "./presence-runtime.js?v=20260919135340";
export {
