 ...
 */
import { popupPlacement } from "../../bridge/popup-placement.js?v=20260920103845";
import { formatZhDateTime } from "../../utils/datetime.js?v=20260920103845";
import {
  cameraPopupLayout,
  cameraPreviewRatio
} from "../../bridge/camera-popup-layout.js?v=20260920103845";
...
} from "./registry.js?v=20260920103845";
import { randomUuid } from "../../utils/random-id.js?v=20260920103845";
...
import { expandHexColorOrNull } from "../../utils/colors.js?v=20260920103845";
...
import { entityDomainFromId, entityDomainOf } from "../../utils/entities.js?v=20260920103845";
...
import { popupLayoutMetrics } from "../../shared/popup-layout.js?v=20260920103845";
import {
...
} from "../controls/climate.js?v=20260920103845";
import {
  applyXiaomiDeviceProfile,
  resolveXiaomiDeviceProfile
} from "./device-profiles.js?v=20260920103845";
import {
  relatedEntityLabel,
...
} from "./entity-power.js?v=20260920103845";
import {
  ICON_VISIBILITY_VIRTUAL_KIND,
  isVirtualEntityId,
  parseVirtualEntityId
} from "../../shared/virtual-entities.js?v=20260920103845";
import { componentActionIsSupported } from "../../shared/action-rules.js?v=20260920103845";
import {
  airflowCanvasOffsetBounds,
  airflowLayerGeometry,
  groupedComponentLocalDelta,
  rotateMultiSelectionTransforms
} from "../geometry/transform-geometry.js?v=20260920103845";
import {
  componentHostZIndex,
  effectCropRectangle,
...
} from "../geometry/effect-geometry.js?v=20260920103845";
import {
  ...
  rgbToHsColor
} from "../controls/light-runtime.js?v=20260920103845";
import { entityMetadataIsAvailable } from "./entity-metadata.js?v=20260920103845";
import {
  relatedVacuumBatteryEntity,
  vacuumActionService,
  vacuumBatteryPercent,
  vacuumSupportedActions
} from "../controls/vacuum-runtime.js?v=20260920103845";
import {
  airerDevicePosition,
...
} from "./runtime-caches.js?v=20260920103845";
import {
  collectComponents,
  collectEntityIds,
  lineChartRuntimeStateNeedsHydration,
  syncedLineChartProperties
} from "./runtime-document.js?v=20260920103845";
