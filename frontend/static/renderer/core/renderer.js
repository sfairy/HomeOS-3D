 ...
 */
import { popupPlacement } from "../../bridge/popup-placement.js?v=2609211953";
...
import {
  cameraPopupLayout,
  cameraPreviewRatio
} from "../../bridge/camera-popup-layout.js?v=2609211953";
...
} from "./registry.js?v=2609211953";
import { randomUuid } from "../../utils/random-id.js?v=2609211953";
import { apiErrorMessage } from "../../utils/api-error.js?v=2609211953";
// 颜色插值统一走 utils/colors.js，避免再出现「同名但失败值不同」的本地副本。
import { mixHexColors, paletteColor } from "../../utils/colors.js?v=2609211953";
...
import { entityDomainFromId, entityDomainOf } from "../../utils/entities.js?v=2609211953";
...
import { popupLayoutMetrics } from "../../shared/popup-layout.js?v=2609211953";
import {
...
} from "../controls/climate.js?v=2609211953";
import {
  applyXiaomiDeviceProfile,
  resolveXiaomiDeviceProfile
} from "./device-profiles.js?v=2609211953";
import {
  relatedEntityLabel,
...
} from "./entity-power.js?v=2609211953";
import {
  ICON_VISIBILITY_VIRTUAL_KIND,
  isVirtualEntityId,
  parseVirtualEntityId
} from "../../shared/virtual-entities.js?v=2609211953";
import { componentActionIsSupported } from "../../shared/action-rules.js?v=2609211953";
import {
  airflowCanvasOffsetBounds,
  airflowLayerGeometry,
  groupedComponentLocalDelta,
  rotateMultiSelectionTransforms
} from "../geometry/transform-geometry.js?v=2609211953";
import {
  componentHostZIndex,
  effectCropRectangle,
...
} from "../geometry/effect-geometry.js?v=2609211953";
import {
  ...
  rgbToHsColor
} from "../controls/light-runtime.js?v=2609211953";
import { entityMetadataIsAvailable } from "./entity-metadata.js?v=2609211953";
import {
  relatedVacuumBatteryEntity,
  vacuumActionService,
  vacuumBatteryPercent,
  vacuumSupportedActions
} from "../controls/vacuum-runtime.js?v=2609211953";
import {
  airerDevicePosition,
...
} from "./runtime-caches.js?v=2609211953";
import {
  collectComponents,
  collectEntityIds,
  lineChartRuntimeStateNeedsHydration,
  syncedLineChartProperties
} from "./runtime-document.js?v=2609211953";
