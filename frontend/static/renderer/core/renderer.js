...
import { setBuiltinAssetVersions } from "./registry.js?v=2609222006";
import { randomUuid } from "../../utils/random-id.js?v=2609222006";
import { airflowCanvasOffsetBounds } from "../geometry/transform-geometry.js?v=2609222006";
import {
  HistoryRefreshCoordinator,
  RuntimeEffectImageLoader,
  RuntimeStaticImageCache,
  RuntimeVacuumMapImagePreloader
} from "./runtime-caches.js?v=2609222006";
import { syncedLineChartProperties } from "./runtime-document.js?v=2609222006";

import { documentCoreMethods } from "./panel-renderer/document-core.js?v=2609222006";
import { selectionTransformMethods } from "./panel-renderer/selection-transform.js?v=2609222006";
import { runtimeBridgeMethods } from "./panel-renderer/runtime-bridge.js?v=2609222006";
import { runtimeDialogMethods } from "./panel-renderer/runtime-dialogs.js?v=2609222006";
import { customPopupMethods } from "./panel-renderer/device-controls/custom-popup.js?v=2609222006";
import { entityDetailsMethods } from "./panel-renderer/device-controls/entity-details.js?v=2609222006";
import { capabilityDetailsMethods } from "./panel-renderer/device-controls/capability.js?v=2609222006";
import { airPurifierDetailsMethods } from "./panel-renderer/device-controls/air-purifier.js?v=2609222006";
import { mediaPlayerDetailsMethods } from "./panel-renderer/device-controls/media-player.js?v=2609222006";
import { lightDetailsMethods } from "./panel-renderer/device-controls/light.js?v=2609222006";
import { coverDetailsMethods } from "./panel-renderer/device-controls/cover.js?v=2609222006";
import { climateDetailsMethods } from "./panel-renderer/device-controls/climate.js?v=2609222006";
import { waterHeaterDetailsMethods } from "./panel-renderer/device-controls/water-heater.js?v=2609222006";
import { electricBedDetailsMethods } from "./panel-renderer/device-controls/electric-bed.js?v=2609222006";
import { vacuumDetailsMethods } from "./panel-renderer/device-controls/vacuum.js?v=2609222006";
import { presenceDetailsMethods } from "./panel-renderer/device-controls/presence.js?v=2609222006";
import { cameraDetailsMethods } from "./panel-renderer/device-controls/camera.js?v=2609222006";
