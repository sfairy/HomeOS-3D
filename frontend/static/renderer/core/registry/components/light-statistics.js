...
import { mdiIconUrl } from "../../../../utils/icon-url.js?v=2609211957";
// 「点亮数量」的激活色默认取全站主控色（见 design/scene/page.css）。
import { paletteColor } from "../../../../utils/colors.js?v=2609211957";
import { lightStatisticsSummary } from "../../../controls/light-statistics-runtime.js?v=2609211957";
// 同门分片：registry-core
