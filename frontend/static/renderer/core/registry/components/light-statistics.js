...
import { clampCoercedNumber } from "../../../../utils/numbers.js?v=2609262312";
...
import { lightStatisticsSummary } from "../../../controls/light-statistics-runtime.js?v=2609262312";
// 同门分片：registry-core
import { registerComponent } from "../registry-core.js?v=2609262312";
// 同门分片：registry-visuals
import {
  applyFontWeight,
  componentContentUnitsPx,
  resolveColor
} from "../registry-visuals.js?v=2609262312";
...
registerComponent("light-statistics", {
  render(statisticsComponent, statisticsContext) {
    ...
    statisticsElement.style.setProperty(
      ...
      resolveColor(statisticsProperties.iconActiveColor, paletteColor("--hos-accent", "#ffc46a"))
    );
    statisticsElement.style.setProperty(
    ...
    statisticsElement.style.setProperty(
      ...
      resolveColor(statisticsProperties.countActiveColor, paletteColor("--hos-accent", "#ffc46a"))
    );
