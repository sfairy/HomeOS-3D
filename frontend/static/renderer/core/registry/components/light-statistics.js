...
import { clampCoercedNumber } from "../../../../utils/numbers.js?v=2609212100";
import { mdiIconUrl } from "../../../../utils/icon-url.js?v=2609212100";
// 「点亮数量」的激活色默认取全站主控色（见 design/scene/page.css）。
import { paletteColor } from "../../../../utils/colors.js?v=2609212100";
import { lightStatisticsSummary } from "../../../controls/light-statistics-runtime.js?v=2609212100";
// 同门分片：registry-core
...
import {
  ...
  resolveColor
} from "../registry-visuals.js?v=2609212100";
