...
import {
  clampCoercedNumber,
  clampNumber
} from "../../../../utils/numbers.js?v=20260921192957";
import { mdiIconUrl } from "../../../../utils/icon-url.js?v=20260921192957";
// 同门分片：entity-state
import { isComponentEntityActive } from "../entity-state.js?v=20260921192957";
// 同门分片：navigation-effects
import {
  buildNavigationEffects,
  navigationButtonIsActive
} from "../navigation-effects.js?v=20260921192957";
// 同门分片：registry-core
...
import {
  ...
  resolveColor
} from "../registry-visuals.js?v=20260921192957";
