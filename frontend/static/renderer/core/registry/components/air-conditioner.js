...
import { clampCoercedNumber } from "../../../../utils/numbers.js?v=20260921152526";
import {
  climateDefaultIcon,
  resolveClimateDeviceType
} from "../../../controls/climate.js?v=20260921152526";
// 状态条目归一统一走 utils/state-entry.js，全仓库只有这一份实现。
import { resolveStateEntry } from "../../../../utils/state-entry.js?v=20260921152526";
import { mdiIconUrl } from "../../../../utils/icon-url.js?v=20260921152526";
// 同门分片：entity-state
import {
  isClimateDeviceActive,
  resolveClimateLabel
} from "../entity-state.js?v=20260921152526";
// 同门分片：registry-core
...
import {
  ...
  resolveColor
} from "../registry-visuals.js?v=20260921152526";
