...
import { clampCoercedNumber } from "../../../../utils/numbers.js?v=2609220023";
import {
  climateDefaultIcon,
...
import { mdiIconUrl } from "../../../../utils/icon-url.js?v=2609220023";
// 同门分片：entity-state
import {
  isClimateDeviceActive,
  resolveClimateLabel
} from "../entity-state.js?v=2609220023";
// 同门分片：registry-core
import { registerComponent } from "../registry-core.js?v=2609220023";
// 同门分片：registry-visuals
import {
  applyFontWeight,
  componentContentUnitsPx,
  resolveColor
} from "../registry-visuals.js?v=2609220023";
