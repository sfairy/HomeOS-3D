 ...
 */
import { lightRealtimeCapabilities } from "../../controls/light-runtime.js?v=2609222006";
...
import { clampCoercedNumber, isUsableNumber } from "../../../utils/numbers.js?v=2609222006";
// 同门分片：builtin-assets
import {
  effectVariantByAssetId,
  resolveAssetUrl
} from "./builtin-assets.js?v=2609222006";
// 同门分片：entity-state
import { isLightVisualActive } from "./entity-state.js?v=2609222006";
