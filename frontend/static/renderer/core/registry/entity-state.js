 ...
 * 词表不同是知识不同，不合并。
 */
import { entityPowerIsOn } from "../entity-power.js?v=20260921152526";
...
import { entityDomainFromId } from "../../../utils/entities.js?v=20260921152526";
// 电机方向的两份知识（读控件配置 / 反转时的四态互换）在叶子模块 cover-direction.js：
// 它不 import 任何东西，避免 cover-runtime.js 与本文件反向 import 成环。
import { coverMotorIsReversedForComponent } from "../../controls/cover-direction.js?v=20260921152526";
import { formatNumericValue } from "../../controls/line-chart-runtime.js?v=20260921152526";
import {
  climateEffectMode,
  climateIsPoweredOn,
  climateModeLabel,
...
} from "../../controls/climate.js?v=20260921152526";
// 同门分片：cover-state
import { coverComponentIsActive } from "./cover-state.js?v=20260921152526";
