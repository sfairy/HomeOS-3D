 ...
 * 词表不同是知识不同，不合并。
 */
import { entityPowerIsOn } from "../entity-power.js?v=2609220052";
...
import { formatNumericValue } from "../../controls/line-chart-runtime.js?v=2609220052";
import {
  climateEffectMode,
  climateIsPoweredOn,
  climateModeLabel,
...
// 同门分片：cover-state
import { coverComponentIsActive } from "./cover-state.js?v=2609220052";
