...
import { relatedPopupContext } from "../../../shared/related-entities.js?v=2609260946";
import {
  entityPowerIsOn,
  entityPowerTarget,
  entityToggleCommand,
  optimisticToggleState
} from "../entity-power.js?v=2609260946";
import {
  ICON_VISIBILITY_VIRTUAL_KIND,
  isVirtualEntityId,
  parseVirtualEntityId
} from "../../../shared/virtual-entities.js?v=2609260946";
import { airflowLayerGeometry } from "../../geometry/transform-geometry.js?v=2609260946";
import { effectFadeDuration } from "../../geometry/effect-geometry.js?v=2609260946";
import { entityMetadataIsAvailable } from "../entity-metadata.js?v=2609260946";
import { relatedVacuumBatteryEntity } from "../../controls/vacuum-runtime.js?v=2609260946";
import {
...
} from "../../controls/cover-runtime.js?v=2609260946";
// 电机方向（读控件配置）在 cover-direction.js：它能被 registry.js 与 cover-runtime.js
// 同时 import（叶子模块，不成环）。本文件只做转出，公开面不变。
import { coverMotorIsReversedForComponent } from "../../controls/cover-direction.js?v=2609260946";
import {
...
} from "../runtime-document.js?v=2609260946";
import {
...
} from "./primitives.js?v=2609260946";
