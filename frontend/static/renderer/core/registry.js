...
import "./registry/components/air-conditioner.js?v=2609231402";
import "./registry/components/camera.js?v=2609231402";
import "./registry/components/date.js?v=2609231402";
import "./registry/components/floorplan-auto-diagram.js?v=2609231402";
import "./registry/components/icon-button.js?v=2609231402";
import "./registry/components/icon-button-effect.js?v=2609231402";
import "./registry/components/image.js?v=2609231402";
import "./registry/components/interaction3d.js?v=2609231402";
import "./registry/components/light-statistics.js?v=2609231402";
import "./registry/components/line-chart.js?v=2609231402";
import "./registry/components/navigation-button.js?v=2609231402";
import "./registry/components/panel-frame.js?v=2609231402";
import "./registry/components/presence-sensor.js?v=2609231402";
import "./registry/components/time.js?v=2609231402";
import "./registry/components/title-button.js?v=2609231402";
import "./registry/components/vacuum-map.js?v=2609231402";
import "./registry/components/weather.js?v=2609231402";

// 分片：airflow
export {
  renderAirConditionerAirflowLayer
} from "./registry/airflow.js?v=2609231402";
// 分片：builtin-assets
export {
  setBuiltinAssetVersions,
  staticAssetImageSource,
  vacuumMapImageSource
} from "./registry/builtin-assets.js?v=2609231402";
// 分片：camera
export {
  mountCameraMedia,
  prewarmCameraMedia
} from "./registry/camera.js?v=2609231402";
// 分片：cover-state
export {
  COVER_POSITION_EPSILON_PERCENT,
  coverComponentIsDream
} from "./registry/cover-state.js?v=2609231402";
// 分片：effect-visuals
export {
  iconButtonEffectLightVisualAwaiting,
  iconButtonEffectLightVisualState,
  renderIconButtonEffectLayer
} from "./registry/effect-visuals.js?v=2609231402";
// 分片：history-chart
export {
  renderLineChartDetails
} from "./registry/history-chart.js?v=2609231402";
// 分片：registry-core
export {
  renderRegisteredComponent
} from "./registry/registry-core.js?v=2609231402";

// ── 各 runtime 纯函数的统一再导出（原样保留）──
import {
  lightStatisticsEntityStateStatus,
  lightStatisticsEntitySupport
} from "../controls/light-statistics-runtime.js?v=2609231402";
import { formatLineChartValue } from "../controls/line-chart-runtime.js?v=2609231402";
import {
  doorWindowPerspectiveCorners,
  doorWindowPerspectiveMatrix
} from "../controls/door-window-runtime.js?v=2609231402";
...
} from "../controls/presence-runtime.js?v=2609231402";
export {
