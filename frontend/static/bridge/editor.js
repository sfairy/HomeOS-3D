 ...
 */
import { resolvePageBehavior } from "./page-behavior.js?v=2609262312";
import {
  performanceWarnings,
  confirmPerformanceWarning
} from "./performance-warning.js?v=2609262312";
import { normalizeGroundReflection } from "./reflection-settings.js?v=2609262312";
import { apiErrorMessage } from "../utils/api-error.js?v=2609262312";
import { SCENE_REQUEST_TIMEOUT_MS } from "../utils/api-fetch.js?v=2609262312";
import {
  requestInteraction3dAccess,
  getInteraction3dEditorView,
  waitInteraction3dEditorView,
  cancelOtherInteraction3dViews
} from "./bridge.js?v=2609262312";
import {
  createInteraction3dCover,
  updateInteraction3dCoverMessage
} from "./cover.js?v=2609262312";
import { withRequestTimeout } from "../utils/request-timeout.js?v=2609262312";
// 交互页面的可选项与运行时树的人体存在显示页判定共用一份，见 utils/interaction-pages.js。
import { INTERACTION_PAGE_OPTIONS } from "../utils/interaction-pages.js?v=2609262312";
import { createDomFactory } from "../shared/dom-factory.js?v=2609262312";
import {
  INTERACTION3D_LIGHTING_MODES,
  normalizeInteraction3dLightingMode,
  BACKGROUND_THEMES,
  normalizeBackgroundTheme
} from "./definition.js?v=2609262312";
  ...
  planRenderButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openInteraction3dAppearanceEditor: openAppearanceEditor } =
        await import("/api/v1/modules/interaction3d/editor/config-editor.js?v=2609262312");
  ...
  configureSecurityButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openSecurityEditor: openSecurityEditor } =
        await import("/api/v1/modules/interaction3d/security/security-editor.js?v=2609262312");
