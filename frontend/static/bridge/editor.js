 ...
 */
import { resolvePageBehavior } from "./page-behavior.js?v=2609220141";
import {
  performanceWarnings,
  confirmPerformanceWarning
} from "./performance-warning.js?v=2609220141";
import { normalizeGroundReflection } from "./reflection-settings.js?v=2609220141";
...
import { INTERACTION_PAGE_OPTIONS } from "../utils/interaction-pages.js?v=2609220141";
import { createDomFactory } from "../shared/dom-factory.js?v=2609220141";
import {
  INTERACTION3D_LIGHTING_MODES,
  normalizeInteraction3dLightingMode,
  BACKGROUND_THEMES,
  normalizeBackgroundTheme
} from "./definition.js?v=2609220141";
  ...
  planRenderButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openInteraction3dAppearanceEditor: openAppearanceEditor } =
        await import("/api/v1/modules/interaction3d/editor/config-editor.js?v=2609220141");
  ...
  configureSecurityButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const { openSecurityEditor: openSecurityEditor } =
        await import("/api/v1/modules/interaction3d/security/security-editor.js?v=2609220141");
