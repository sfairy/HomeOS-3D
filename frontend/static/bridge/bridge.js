 ...
 */
import { createAccessMonitor } from "./access-monitor.js?v=2609251851";
import { createInteraction3dCover } from "./cover.js?v=2609251851";
import { createInteraction3dFocusLayout } from "./focus-layout.js?v=2609251851";
/**
...
export function renderInteraction3d(component, context = {}) {
  ...
  const unsubscribeAccess = subscribeInteraction3dAccess(async accessState => {
    ...
    try {
      ...
      const runtimeModule =
        await import("/api/v1/modules/interaction3d/core/runtime.js?v=2609251851");
