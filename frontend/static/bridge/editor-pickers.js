...
} from "../editor/picker/editor-picker-pagination.js?v=2609260929";
import { createEditorPickerQueries } from "../editor/picker/editor-picker-queries.js?v=2609260929";
...
import { vacuumProfiles } from "./vacuum-catalog.js?v=2609260929";
import { nasProfiles } from "./nas-catalog.js?v=2609260929";
// 温湿度计的传感器判定与运行侧、后端同一份实现（static 共享层，零依赖）。
import { matchesTemperatureHumidityEntity } from "./temperature-humidity.js?v=2609260929";
