...
import { normalizeGroundReflection } from "../../bridge/reflection-settings.js?v=2609231402";
import { createReflectionCulling } from "./studio-reflection-culling.js?v=2609231402";
/**
 * 创建地面反射控制器（一个渲染器一份）。
