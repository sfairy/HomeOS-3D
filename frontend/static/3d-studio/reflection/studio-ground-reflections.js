...
import { normalizeGroundReflection } from "../../bridge/reflection-settings.js?v=20260921090405";
import { createReflectionCulling } from "./studio-reflection-culling.js?v=20260921090405";
/**
 * 创建地面反射控制器（一个渲染器一份）。
