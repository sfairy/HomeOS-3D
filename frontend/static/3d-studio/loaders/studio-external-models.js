 ...
 */
import { finite } from "./studio-normalization.js?v=2609252210";
...
import { createModelPersistentCache } from "../model-persistent-cache.js?v=2609252210";
import { modelTemplateKey } from "../model-template-codec.js?v=2609252210";
// 主题专用的两个模块：地板材质着色器增强（场景，看 palette.warmWood）与树叶几何放大
// （家居，看 palette.warmFurniture）。两者都只在对应开关为真时被调用，其它情况下不产生任何效果。
import { decorateWarmFloor } from "../studio/studio-scene-style.js?v=2609252210";
import { enlargeWarmLeaves } from "../materials/studio-warm-foliage.js?v=2609252210";
// 石材板整图（茶几的两块石板、餐桌台面）：与背景墙的「大理石」共用白色色号那张缓存贴图，
// 另加一个黑金大理石色号（背景墙没有这一档，见 createStoneSlabTexture 的注释）。
import { createStoneSlabTexture } from "../materials/studio-surface-textures.js?v=2609252210";
// 逐物件「材质风格」的质感贴图（均值≈1 的细节图）：走调色板上的 materialSurface 键。
import {
  createMaterialSurfaceTexture,
  hasMaterialSurfaceTexture
} from "../materials/studio-surface-fabrics.js?v=2609252210";
...
import {
  ...
  JOINERY_ITEM_TYPES
} from "../studio/studio-item-types.js?v=2609252210";
const HOME_LITE_MODEL_VERSION = "2609252210";
const APPLIANCE_LITE_MODEL_VERSION = "2609252210";
/**
