 ...
 */
import { finite } from "./studio-normalization.js?v=2609262312";
...
import { createModelPersistentCache } from "../model-persistent-cache.js?v=2609262312";
import { modelTemplateKey } from "../model-template-codec.js?v=2609262312";
// 主题专用的两个模块：地板材质着色器增强（场景，看 palette.warmWood）与树叶几何放大
// （家居，看 palette.warmFurniture）。两者都只在对应开关为真时被调用，其它情况下不产生任何效果。
import { decorateWarmFloor } from "../studio/studio-scene-style.js?v=2609262312";
import { enlargeWarmLeaves } from "../materials/studio-warm-foliage.js?v=2609262312";
...
import {
  ...
  JOINERY_ITEM_TYPES
} from "../studio/studio-item-types.js?v=2609262312";
...
const HOME_LITE_MODEL_VERSION = "2609262312";
const APPLIANCE_LITE_MODEL_VERSION = "2609262312";
/**
