 ...
 */
import { finite } from "./studio-normalization.js?v=2609251851";
...
import { decorateWarmFloor } from "../studio/studio-scene-style.js?v=2609251851";
import { enlargeWarmLeaves } from "../materials/studio-warm-foliage.js?v=2609251851";
// 石材板整图（茶几的两块石板、餐桌台面）：与背景墙的「大理石」共用白色色号那张缓存贴图，
// 另加一个黑金大理石色号（背景墙没有这一档，见 createStoneSlabTexture 的注释）。
import { createStoneSlabTexture } from "../materials/studio-surface-textures.js?v=2609251851";
// 逐物件「材质风格」的质感贴图（均值≈1 的细节图）：走调色板上的 materialSurface 键。
import {
  createMaterialSurfaceTexture,
  hasMaterialSurfaceTexture
} from "../materials/studio-surface-fabrics.js?v=2609251851";
...
import {
  ...
  JOINERY_ITEM_TYPES
} from "../studio/studio-item-types.js?v=2609251851";
const HOME_LITE_MODEL_VERSION = "2609251851";
const APPLIANCE_LITE_MODEL_VERSION = "2609251851";
/**
