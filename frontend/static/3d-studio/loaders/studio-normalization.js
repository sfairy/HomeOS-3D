 ...
 */
import { clampNumber, coercedFiniteNumberOr } from "../../utils/numbers.js?v=2609251801";
// 色温换算（含唯一的公式与单通道夹取）共用 utils/colors.js：studio 侧与灯光侧的系数不许各写一份。
import { kelvinToRgbHex as normalizedKelvinToRgbHex } from "../../utils/colors.js?v=2609251801";
