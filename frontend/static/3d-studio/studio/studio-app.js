 ...
 * （body 带 currentRevision），前端弹冲突框让用户选，绝不静默覆盖；导出走
...
import {
  ...
  curtainPanelRanges,
  addTrackCurtain
} from "../loaders/studio-curtain-track.js?v=2609251851";
import { drawTelevisionPoster } from "../materials/studio-television-poster.js?v=2609251851";
import { apiAuthChallenge, apiRequestError } from "../../utils/api-request.js?v=2609251851";
import { capturePointer, releasePointer } from "../../utils/pointer-capture.js?v=2609251851";
// 浮动菜单的统一定位（按实测尺寸夹进视口 / 翻转），与编辑器共用一份。
import {
  moveFloatingPanelIntoBounds,
  positionPointMenu
} from "../../shared/menu-positioning.js?v=2609251851";
import { paletteColor } from "../../utils/colors.js?v=2609251851";
import { roundToDecimals } from "../../utils/numbers.js?v=2609251851";
// 未绑定窗帘的默认开合度：与运行时的未绑定兜底同值，只定义在 utils/cover-features.js 一处。
import { COVER_DEFAULT_PREVIEW_POSITION } from "../../utils/cover-features.js?v=2609251851";
import { yieldToIdle, yieldToScheduler } from "./studio-yield.js?v=2609251851";
...
} from "./studio-item-types.js?v=2609251851";
// 物件模型的构建分派：谓词 + 62 个构建体都在 item-builders/ 下，
// 本文件只提供它们需要的模块私有依赖（ITEM_BUILDER_DEPS）与本次调用的入参。
import { buildItemBody, finishItemModel } from "./item-builders/registry.js?v=2609251851";
import {
...
} from "../materials/studio-surface-textures.js?v=2609251851";
import { createOverviewStack } from "./studio-overview-stack.js?v=2609251851";
import { windowGeometryParts } from "../plan/studio-window-geometry.js?v=2609251851";
import {
  MAX_CAMERA_POLAR_ANGLE,
  constrainCameraPosition,
  constrainCameraPose
} from "./studio-camera-constraints.js?v=2609251851";
import { addSecurityModel } from "../loaders/studio-security-models.js?v=2609251851";
import { createFloorTransition } from "./studio-floor-transition.js?v=2609251851";
import { floorOpeningPolygon } from "../plan/studio-floor-openings.js?v=2609251851";
import { createGroundReflections } from "../reflection/studio-ground-reflections.js?v=2609251851";
import { createMotionPresentation } from "./studio-motion-presentation.js?v=2609251851";
import { renderStudioAssetPalette } from "./studio-asset-palette.js?v=2609251851";
import {
  createWallSideMaterial,
  setWallGradientHeight,
  setWallCornerDistances
} from "../materials/studio-wall-materials.js?v=2609251851";
import {
  WARM_HOME_STYLE,
  WARM_WOOD_STYLE,
  applyItemFinish,
  decorateWarmFloor
} from "./studio-scene-style.js?v=2609251851";
...
import {
  ...
  applyMaterialStyle
} from "./studio-material-styles.js?v=2609251851";
import { createWarmTelevisionGlass } from "../materials/studio-television-glass.js?v=2609251851";
import {
  ...
  sha256,
  stableCacheJSON
} from "../../bridge/render-cache.js?v=2609251851";
import { transformSceneCamera } from "../../bridge/scene-frame.js?v=2609251851";
import { sceneUpdatePlan } from "../../bridge/scene-update.js?v=2609251851";
import { createDemandFrameLoop } from "../../bridge/frame-loop.js?v=2609251851";
import { cacheObjectTransforms } from "../../bridge/scene-matrices.js?v=2609251851";
import { withRequestTimeout } from "../../utils/request-timeout.js?v=2609251851";
// 3D 场景接口的超时预算：与编辑器桥（bridge/editor.js）读同一个常量，避免两侧各写一个字面量。
import { SCENE_REQUEST_TIMEOUT_MS } from "../../utils/api-fetch.js?v=2609251851";
// 生产控制台的诊断输出统一走 utils/debug-log.js：debugLog 默认静默（只在 ?debug=1 时输出）。
import { debugLog } from "../../utils/debug-log.js?v=2609251851";
// 接口请求的超时预算由 utils/api-fetch.js 统一持有（requestStudioApi 是唯一出入口）。
import { apiFetch } from "../../utils/api-fetch.js?v=2609251851";
import * as threeModuleMin from "/static/vendor/three/0.186.0/three.module.min.js";
import { OrbitControls } from "/static/vendor/three/0.186.0/OrbitControls.js?v=2609251851";
...
import { GLTFLoader } from "/static/vendor/three/0.186.0/GLTFLoader.js?v=2609251851";
import { SameOriginDRACOLoader } from "../export/draco-loader.js?v=2609251851";
import {
  ...
  mapLightEffectState,
  lightEffectColorHex
} from "../../bridge/light-motion.js?v=2609251851";
import {
  ...
  wallJoinExtensions,
  wallSolidPieces
} from "../plan/geometry.js?v=2609251851";
import {
...
} from "../export/export-utils.js?v=2609251851";
// 布局层（折叠 / 拖拽调宽 / 状态记忆）与折叠快捷键都在 shared/ 下，与 /index 编辑器共用同一份
// 实现：两页的三栏骨架、分隔条交互、状态记忆是同一套需求，各写一份必然漂移。
import {
  createLayoutController,
  bindLayoutControls
} from "../../shared/layout-shell.js?v=2609251851";
import { bindLayoutShortcuts } from "../../shared/layout-shortcuts.js?v=2609251851";
import {
...
} from "../export/export-presets.js?v=2609251851";
import { reorderFloors } from "../plan/floor-order.js?v=2609251851";
import { syncControlValue } from "./ui-controls.js?v=2609251851";
import {
  initializeNumberInputs,
  initializeStudioSelects,
  syncStudioSelect
} from "./studio-widgets.js?v=2609251851";
import {
  createExternalModelManager,
  ALL_ITEM_MODELS
} from "../loaders/studio-external-models.js?v=2609251851";
import {
  createPlanDrawingTools,
  drawTrackedText
} from "../plan/studio-plan-drawing.js?v=2609251851";
import { createSpotShadowAtlasController } from "./studio-shadow-atlas.js?v=2609251851";
import { createRegionLightController, REGION_LIGHT_LAYER } from "../plan/studio-plan2-region-lights.js?v=2609251851";
import { createContactShadowController } from "../plan/studio-plan2-contact-shadows.js?v=2609251851";
import {
  ...
  normalizeLabelText,
  normalizePoint
} from "../loaders/studio-normalization.js?v=2609251851";
/**
...
const dracoLoader = new SameOriginDRACOLoader(
  "/static/3d-studio/export/draco-decoder-worker.js?v=2609251851"
);
  ...
  const normalizedDoors = Array.isArray(raw.doors)
    ? raw.doors
        .map(rawDoor => ({
          ...
          sill: 0,
          doorType: Object.hasOwn(DOOR_TYPE_DIMENSIONS, rawDoor?.doorType)
            ? rawDoor.doorType
            : "solid",
...
function resolveSharedWallMaterial(wallColor, wallMaterialOptions = {}) {
  ...
  if (!materialByRenderKey.has(wallMaterialCacheKey)) {
    materialByRenderKey.set(
      wallMaterialCacheKey,
 ...
 */
function addWindowFrameMeshes(frameParent, windowPanes, frameColor, glassColor) {
  const frameOptions = {
    rounded: false,
    metalness: 0.18,
    roughness: 0.36,
...
function buildPillarItemMeshGroup(group, item, itemWidth, itemDepth, itemHeight, palette) {
  ...
  const pillarMaterial = makeWallSideMaterial(palette.wall, pillarWallOpacity, {
    depthWrite: false,
  ...
  try {
    ...
    if (isStageViewerMode) {
      ...
      const { mountStage: mountStage } =
        await import("/api/v1/modules/interaction3d/core/stage.js?v=2609251851");
