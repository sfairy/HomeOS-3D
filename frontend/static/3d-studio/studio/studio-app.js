...
import {
  ...
  addRollerCurtain,
  addTrackCurtain
} from "../loaders/studio-curtain-track.js?v=2609260900";
import { drawTelevisionPoster } from "../materials/studio-television-poster.js?v=2609260900";
import { apiAuthChallenge, apiRequestError } from "../../utils/api-request.js?v=2609260900";
import { capturePointer, releasePointer } from "../../utils/pointer-capture.js?v=2609260900";
...
import { roundToDecimals } from "../../utils/numbers.js?v=2609260900";
...
import { yieldToIdle, yieldToScheduler } from "./studio-yield.js?v=2609260900";
...
} from "./studio-item-types.js?v=2609260900";
// 物件模型的构建分派：谓词 + 62 个构建体都在 item-builders/ 下，
// 本文件只提供它们需要的模块私有依赖（ITEM_BUILDER_DEPS）与本次调用的入参。
import { buildItemBody, finishItemModel } from "./item-builders/registry.js?v=2609260900";
import {
...
} from "../materials/studio-surface-textures.js?v=2609260900";
import { createOverviewStack } from "./studio-overview-stack.js?v=2609260900";
import { windowGeometryParts } from "../plan/studio-window-geometry.js?v=2609260900";
import {
  MAX_CAMERA_POLAR_ANGLE,
  constrainCameraPosition,
  constrainCameraPose
} from "./studio-camera-constraints.js?v=2609260900";
import { addSecurityModel } from "../loaders/studio-security-models.js?v=2609260900";
import { createFloorTransition } from "./studio-floor-transition.js?v=2609260900";
import { floorOpeningPolygon } from "../plan/studio-floor-openings.js?v=2609260900";
import { createGroundReflections } from "../reflection/studio-ground-reflections.js?v=2609260900";
import { createMotionPresentation } from "./studio-motion-presentation.js?v=2609260900";
import { renderStudioAssetPalette } from "./studio-asset-palette.js?v=2609260900";
import {
  createWallSideMaterial,
  setWallGradientHeight,
  setWallCornerDistances
} from "../materials/studio-wall-materials.js?v=2609260900";
import {
  WARM_HOME_STYLE,
  WARM_WOOD_STYLE,
  applyItemFinish,
  decorateWarmFloor
} from "./studio-scene-style.js?v=2609260900";
...
import {
  ...
  applyMaterialStyle
} from "./studio-material-styles.js?v=2609260900";
import { createWarmTelevisionGlass } from "../materials/studio-television-glass.js?v=2609260900";
import {
  ...
  sha256,
  stableCacheJSON
} from "../../bridge/render-cache.js?v=2609260900";
import { transformSceneCamera } from "../../bridge/scene-frame.js?v=2609260900";
import { sceneUpdatePlan } from "../../bridge/scene-update.js?v=2609260900";
import { createDemandFrameLoop } from "../../bridge/frame-loop.js?v=2609260900";
import { cacheObjectTransforms } from "../../bridge/scene-matrices.js?v=2609260900";
import { withRequestTimeout } from "../../utils/request-timeout.js?v=2609260900";
// 3D 场景接口的超时预算：与编辑器桥（bridge/editor.js）读同一个常量，避免两侧各写一个字面量。
import { SCENE_REQUEST_TIMEOUT_MS } from "../../utils/api-fetch.js?v=2609260900";
...
import { createLoadTiming } from "../../bridge/load-timing.js?v=2609260900";
// 舞台页的提前起跑（舞台页里非 null）：它已经替我们读过场景持久缓存、发过场景接口请求、
// 开始下载 stage 模块 —— 三件事都直接复用，绝不再做第二遍。
import { stageStartup } from "../stage-startup.js?v=2609260900";
// 场景持久缓存：把「归一后的场景文档」跨会话存起来，舞台页二次打开时跳过整段逐层归一。
import { prepareSceneDocument } from "../scene-persistent-cache.js?v=2609260900";
...
import { OrbitControls } from "/static/vendor/three/0.186.0/OrbitControls.js?v=2609260900";
...
import { GLTFLoader } from "/static/vendor/three/0.186.0/GLTFLoader.js?v=2609260900";
import { SameOriginDRACOLoader } from "../export/draco-loader.js?v=2609260900";
import {
  ...
  mapLightEffectState,
  lightEffectColorHex
} from "../../bridge/light-motion.js?v=2609260900";
import {
  ...
  wallJoinExtensions,
  wallSolidPieces
} from "../plan/geometry.js?v=2609260900";
import {
...
} from "../export/export-utils.js?v=2609260900";
// 布局层（折叠 / 拖拽调宽 / 状态记忆）与折叠快捷键都在 shared/ 下，与 /index 编辑器共用同一份
// 实现：两页的三栏骨架、分隔条交互、状态记忆是同一套需求，各写一份必然漂移。
import {
  createLayoutController,
  bindLayoutControls
} from "../../shared/layout-shell.js?v=2609260900";
import { bindLayoutShortcuts } from "../../shared/layout-shortcuts.js?v=2609260900";
import {
...
} from "../export/export-presets.js?v=2609260900";
import { reorderFloors } from "../plan/floor-order.js?v=2609260900";
import { syncControlValue } from "./ui-controls.js?v=2609260900";
import {
  initializeNumberInputs,
  initializeStudioSelects,
  syncStudioSelect
} from "./studio-widgets.js?v=2609260900";
import {
  createExternalModelManager,
  ALL_ITEM_MODELS
} from "../loaders/studio-external-models.js?v=2609260900";
import {
  createPlanDrawingTools,
  drawTrackedText
} from "../plan/studio-plan-drawing.js?v=2609260900";
import { createSpotShadowAtlasController } from "./studio-shadow-atlas.js?v=2609260900";
import { createRegionLightController, REGION_LIGHT_LAYER } from "../plan/studio-plan2-region-lights.js?v=2609260900";
import { createContactShadowController } from "../plan/studio-plan2-contact-shadows.js?v=2609260900";
import {
  ...
  normalizeLabelText,
  normalizePoint
} from "../loaders/studio-normalization.js?v=2609260900";
/**
...
const dracoLoader = new SameOriginDRACOLoader(
  "/static/3d-studio/export/draco-decoder-worker.js?v=2609260900"
);
  ...
  try {
    ...
    if (isStageViewerMode) {
      ...
      const { mountStage: mountStage } = await (stageStartup?.module ||
        import("/api/v1/modules/interaction3d/core/stage.js?v=2609260900"));
