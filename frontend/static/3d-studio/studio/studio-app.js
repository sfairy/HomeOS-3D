...
import {
  ...
  curtainPanelRanges,
  addTrackCurtain
} from "../loaders/studio-curtain-track.js?v=2609220023";
import { drawTelevisionPoster } from "../materials/studio-television-poster.js?v=2609220023";
import { apiAuthChallenge, apiRequestError } from "../../utils/api-request.js?v=2609220023";
import { capturePointer, releasePointer } from "../../utils/pointer-capture.js?v=2609220023";
import { paletteColor } from "../../utils/colors.js?v=2609220023";
import { roundToDecimals } from "../../utils/numbers.js?v=2609220023";
import { yieldToIdle, yieldToScheduler } from "./studio-yield.js?v=2609220023";
...
} from "./studio-item-types.js?v=2609220023";
// 物件模型的构建分派：谓词 + 62 个构建体都在 item-builders/ 下，
// 本文件只提供它们需要的模块私有依赖（ITEM_BUILDER_DEPS）与本次调用的入参。
import { buildItemBody, finishItemModel } from "./item-builders/registry.js?v=2609220023";
import {
...
} from "../materials/studio-surface-textures.js?v=2609220023";
import { createOverviewStack } from "./studio-overview-stack.js?v=2609220023";
import { windowGeometryParts } from "../plan/studio-window-geometry.js?v=2609220023";
import {
  MAX_CAMERA_POLAR_ANGLE,
  constrainCameraPosition,
  constrainCameraPose
} from "./studio-camera-constraints.js?v=2609220023";
import { addSecurityModel } from "../loaders/studio-security-models.js?v=2609220023";
import { createFloorTransition } from "./studio-floor-transition.js?v=2609220023";
import { floorOpeningPolygon } from "../plan/studio-floor-openings.js?v=2609220023";
import { createGroundReflections } from "../reflection/studio-ground-reflections.js?v=2609220023";
import { createMotionPresentation } from "./studio-motion-presentation.js?v=2609220023";
import { renderStudioAssetPalette } from "./studio-asset-palette.js?v=2609220023";
import {
  createWallSideMaterial,
  setWallGradientHeight,
  setWallCornerDistances
} from "../materials/studio-wall-materials.js?v=2609220023";
import {
  WARM_WOOD_STYLE,
  decorateWarmFloor
} from "./studio-scene-style.js?v=2609220023";
import { createWarmTelevisionGlass } from "../materials/studio-television-glass.js?v=2609220023";
import {
  ...
  sha256,
  stableCacheJSON
} from "../../bridge/render-cache.js?v=2609220023";
import { transformSceneCamera } from "../../bridge/scene-frame.js?v=2609220023";
import { sceneUpdatePlan } from "../../bridge/scene-update.js?v=2609220023";
import { createDemandFrameLoop } from "../../bridge/frame-loop.js?v=2609220023";
import { cacheObjectTransforms } from "../../bridge/scene-matrices.js?v=2609220023";
import { withRequestTimeout } from "../../utils/request-timeout.js?v=2609220023";
// 3D 场景接口的超时预算：与编辑器桥（bridge/editor.js）读同一个常量，避免两侧各写一个字面量。
import { SCENE_REQUEST_TIMEOUT_MS } from "../../utils/api-fetch.js?v=2609220023";
...
import { apiFetch } from "../../utils/api-fetch.js?v=2609220023";
import * as threeModuleMin from "/static/vendor/three/0.182.0/three.module.min.js";
import { OrbitControls } from "/static/vendor/three/0.182.0/OrbitControls.js?v=2609220023";
...
import { GLTFLoader } from "/static/vendor/three/0.182.0/GLTFLoader.js?v=2609220023";
import { SameOriginDRACOLoader } from "../export/draco-loader.js?v=2609220023";
import {
  ...
  mapLightEffectState,
  lightEffectColorHex
} from "../../bridge/light-motion.js?v=2609220023";
import {
  ...
  wallJoinExtensions,
  wallSolidPieces
} from "../plan/geometry.js?v=2609220023";
import {
...
} from "../export/export-utils.js?v=2609220023";
import {
...
} from "../export/export-presets.js?v=2609220023";
import { reorderFloors } from "../plan/floor-order.js?v=2609220023";
import { syncControlValue } from "./ui-controls.js?v=2609220023";
import {
  initializeNumberInputs,
  initializeStudioSelects,
  syncStudioSelect
} from "./studio-widgets.js?v=2609220023";
import {
  createExternalModelManager,
  ALL_ITEM_MODELS
} from "../loaders/studio-external-models.js?v=2609220023";
import {
  createPlanDrawingTools,
  drawTrackedText
} from "../plan/studio-plan-drawing.js?v=2609220023";
import { createSpotShadowAtlasController } from "./studio-shadow-atlas.js?v=2609220023";
import { createRegionLightController, REGION_LIGHT_LAYER } from "../plan/studio-plan2-region-lights.js?v=2609220023";
import { createContactShadowController } from "../plan/studio-plan2-contact-shadows.js?v=2609220023";
import {
  ...
  normalizeLabelText,
  normalizePoint
} from "../loaders/studio-normalization.js?v=2609220023";
/**
...
const dracoLoader = new SameOriginDRACOLoader(
  "/static/3d-studio/export/draco-decoder-worker.js?v=2609220023"
);
  ...
  try {
    ...
    if (isStageViewerMode) {
      ...
      const { mountStage: mountStage } =
        await import("/api/v1/modules/interaction3d/core/stage.js?v=2609220023");
