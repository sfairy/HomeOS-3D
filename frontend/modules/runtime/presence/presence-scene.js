...
import { resolveStateEntry } from "../core/static-helpers.js?v=2609251754";
// 「减少动态效果」偏好的唯一判定。
import { prefersReducedMotionNow } from "../core/motion-preference.js?v=2609251754";
// 模型定位键（楼层 + 模型）的唯一实现在 core/scene-model-key.js。
import { sceneModelKey } from "../core/scene-model-key.js?v=2609251754";
import { createWalker, animateWalker, disposeWalker } from "./presence-character.js?v=2609251754";
import {
  validPresenceRoute,
