 ...
 */
import { openPresenceFocusEditor } from "./presence-focus-editor.js?v=2609262221";
...
} from "./presence-motion.js?v=2609262221";
import { DESIGNS, createWalker, animateWalker, disposeWalker } from "./presence-character.js?v=2609262221";
...
import { serializeEditorDraft } from "../core/editor-save-status.js?v=2609262221";
/**
 * 打开人在传感器编辑对话框。
 */
export async function openPresenceEditor({
  ...
  styleLinkElement.href =
    "/api/v1/modules/interaction3d/presence/presence-editor.css?v=2609262221";
