 ...
 */
import { openPresenceFocusEditor } from "./presence-focus-editor.js?v=2609260929";
...
} from "./presence-motion.js?v=2609260929";
import { DESIGNS, createWalker, animateWalker, disposeWalker } from "./presence-character.js?v=2609260929";
import { capturePointer } from "../core/static-helpers.js?v=2609260929";
import {
  createDomFactory,
  randomUuid,
  toSvgPoint as bridgedToSvgPoint
} from "../core/static-helpers-editor.js?v=2609260929";
import { serializeEditorDraft } from "../core/editor-save-status.js?v=2609260929";
/**
 * 打开人在传感器编辑对话框。
 */
export async function openPresenceEditor({
  ...
  styleLinkElement.href =
    "/api/v1/modules/interaction3d/presence/presence-editor.css?v=2609260929";
