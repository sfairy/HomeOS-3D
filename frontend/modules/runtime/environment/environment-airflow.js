...
import { normalizedTextOf, paletteColor, readFromMapOrRecord, resolveStateEntry, stateTextOf, AIRFLOW_OTHER_COLOR } from "../core/static-helpers.js?v=2609231046";
// 模型定位键（楼层 + 模型）的唯一实现在 core/scene-model-key.js。
import { sceneModelKey } from "../core/scene-model-key.js?v=2609231046";
import { modelWorldBounds } from "../core/scene-model-bounds.js?v=2609231046";
// 「减少动态效果」偏好的唯一判定与订阅（实现见 core/motion-preference.js）。
import { onReducedMotionChange, prefersReducedMotionNow } from "../core/motion-preference.js?v=2609231046";
