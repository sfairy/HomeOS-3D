...
import { readFromMapOrRecord, resolveStateEntry, stateTextOf } from "../core/static-helpers.js?v=2609220943";
...
import { createEnvironmentHalos } from "./environment-halos.js?v=2609220943";
/**
 * 计算「当前页面应该压暗多少、降饱和多少」。
 */
