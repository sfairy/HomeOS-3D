...
import { resolveStateEntry, stateTextOf } from "../core/static-helpers.js?v=2609211957";
// 模型定位键（楼层 + 模型）的唯一实现在 core/scene-model-key.js —— 本文件原来是它的原始出处，
// 现已提为共享实现，其余模块不再各写一份。
import { sceneModelKey } from "../core/scene-model-key.js?v=2609211957";
// 「减少动态效果」偏好的唯一判定。
import { prefersReducedMotionNow } from "../core/motion-preference.js?v=2609211957";
import { createEnvironmentHalos } from "./environment-halos.js?v=2609211957";
/**
 * 计算「当前页面应该压暗多少、降饱和多少」。
 */
