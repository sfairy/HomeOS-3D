...
import { vacuumMapIdentity } from "./vacuum-map.js?v=20260920093608";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=20260920093608";
import { mountInteraction3d } from "./runtime.js?v=20260920093608";
import { lightState } from "./light-state.js?v=20260920093608";
import { openVacuumMapEditor } from "./vacuum-map-editor.js?v=20260920093608";
...
} from "./editor-save-status.js?v=20260920093608";
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/runtime.css?v=20260920093608";
