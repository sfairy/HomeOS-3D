...
import { COVER_DEFAULT_PREVIEW_POSITION } from "../core/static-helpers.js?v=2609251801";
...
const {
  ...
  ? import(
      new URL(
        "../../../static/3d-studio/loaders/studio-curtain-track.js?v=2609251801",
        import.meta.url
      )
    )
  : import("/static/3d-studio/loaders/studio-curtain-track.js?v=2609251801"));
