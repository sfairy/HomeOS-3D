...
import { vacuumMapIdentity } from "../vacuum/vacuum-map.js?v=2609220052";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=2609220052";
import { mountInteraction3d } from "../core/runtime.js?v=2609220052";
import { lightState } from "../light/light-state.js?v=2609220052";
import { openVacuumMapEditor } from "../vacuum/vacuum-map-editor.js?v=2609220052";
import { nasGroups } from "../nas/nas-panel.js?v=2609220052";
import {
  EDITOR_SAVE_STATUS,
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/core/runtime.css?v=2609220052";
