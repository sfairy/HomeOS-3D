...
} from "../core/static-helpers-editor.js?v=2609252218";
import { vacuumMapIdentity } from "../vacuum/vacuum-map.js?v=2609252218";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=2609252218";
import { mountInteraction3d } from "../core/runtime.js?v=2609252218";
import { lightState } from "../light/light-state.js?v=2609252218";
import { openVacuumMapEditor } from "../vacuum/vacuum-map-editor.js?v=2609252218";
import { nasGroups } from "../nas/nas-panel.js?v=2609252218";
...
} from "./device-entity-config.js?v=2609252218";
// 状态判定的「两种状态 + 中文名」词表（状态灯规则下拉的唯一来源）与规则缺省值。
import {
  defaultDeviceStatusRule,
  deviceStatusChoices
} from "../device/device-status.js?v=2609252218";
...
} from "../climate/purifier-extras.js?v=2609252218";
import {
  EDITOR_SAVE_STATUS,
  editorDraftHasChanges,
  serializeEditorDraft
} from "../core/editor-save-status.js?v=2609252218";
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/core/runtime.css?v=2609252218";
  ...
  deviceStyleLinkElement.href =
    "/api/v1/modules/interaction3d/editor/device-editor.css?v=2609252218";
  ...
  const ensureExtraStyles = () => {
    ...
    extraStyleLinkElement.href =
      "/api/v1/modules/interaction3d/climate/climate-panel.css?v=2609252218";
