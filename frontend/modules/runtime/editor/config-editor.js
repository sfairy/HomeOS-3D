...
import { vacuumMapIdentity } from "../vacuum/vacuum-map.js?v=20260921151446";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=20260921151446";
import { mountInteraction3d } from "../core/runtime.js?v=20260921151446";
import { lightState } from "../light/light-state.js?v=20260921151446";
import { openVacuumMapEditor } from "../vacuum/vacuum-map-editor.js?v=20260921151446";
import { nasGroups } from "../nas/nas-panel.js?v=20260921151446";
import { randomUuid } from "/static/utils/random-id.js?v=20260921151446";
import { interaction3dPreviewSize } from "/static/bridge/preview-layout.js?v=20260921151446";
...
import { normalizeInteraction3dLightingMode } from "/static/bridge/definition.js?v=20260921151446";
import {
  DEFAULT_BASE_LIGHTING,
  normalizeBaseLighting
} from "/static/3d-studio/loaders/studio-normalization.js?v=20260921151446";
import {
  EDITOR_SAVE_STATUS,
  editorDraftHasChanges,
  serializeEditorDraft
} from "../core/editor-save-status.js?v=20260921151446";
import { confirmAction } from "/static/shared/ui-confirm.js?v=20260921151446";
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/core/runtime.css?v=20260921151446";
