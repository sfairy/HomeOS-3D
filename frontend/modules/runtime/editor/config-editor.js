...
import { capturePointer, resolveStateEntry } from "../core/static-helpers.js?v=2609220023";
import {
...
import { vacuumMapIdentity } from "../vacuum/vacuum-map.js?v=2609220023";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=2609220023";
import { mountInteraction3d } from "../core/runtime.js?v=2609220023";
import { lightState } from "../light/light-state.js?v=2609220023";
import { openVacuumMapEditor } from "../vacuum/vacuum-map-editor.js?v=2609220023";
import { nasGroups } from "../nas/nas-panel.js?v=2609220023";
import {
  EDITOR_SAVE_STATUS,
