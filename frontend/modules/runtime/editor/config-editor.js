...
import { resolveStateEntry } from "../core/static-helpers.js?v=2609211953";
import { vacuumMapIdentity } from "../vacuum/vacuum-map.js?v=2609211953";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=2609211953";
import { mountInteraction3d } from "../core/runtime.js?v=2609211953";
import { lightState } from "../light/light-state.js?v=2609211953";
import { openVacuumMapEditor } from "../vacuum/vacuum-map-editor.js?v=2609211953";
import { nasGroups } from "../nas/nas-panel.js?v=2609211953";
import { randomUuid } from "/static/utils/random-id.js?v=2609211953";
import { interaction3dPreviewSize } from "/static/bridge/preview-layout.js?v=2609211953";
import { capturePointer } from "/static/utils/pointer-capture.js?v=2609211953";
import {
  requestInteraction3dAccess,
  getInteraction3dEditorView,
  subscribeInteraction3dAccess
} from "/static/bridge/bridge.js?v=2609211953";
import { normalizeInteraction3dLightingMode } from "/static/bridge/definition.js?v=2609211953";
import {
  DEFAULT_BASE_LIGHTING,
  normalizeBaseLighting
} from "/static/3d-studio/loaders/studio-normalization.js?v=2609211953";
import {
  EDITOR_SAVE_STATUS,
  editorDraftHasChanges,
  serializeEditorDraft
} from "../core/editor-save-status.js?v=2609211953";
import { confirmAction } from "/static/shared/ui-confirm.js?v=2609211953";
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/core/runtime.css?v=2609211953";
