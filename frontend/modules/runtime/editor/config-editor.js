...
import { vacuumMapIdentity } from "../vacuum/vacuum-map.js?v=2609231046";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=2609231046";
import { mountInteraction3d } from "../core/runtime.js?v=2609231046";
import { lightState } from "../light/light-state.js?v=2609231046";
import { openVacuumMapEditor } from "../vacuum/vacuum-map-editor.js?v=2609231046";
import { nasGroups } from "../nas/nas-panel.js?v=2609231046";
import {
  EDITOR_SAVE_STATUS,
  editorDraftHasChanges,
  serializeEditorDraft
} from "../core/editor-save-status.js?v=2609231046";
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/core/runtime.css?v=2609231046";
