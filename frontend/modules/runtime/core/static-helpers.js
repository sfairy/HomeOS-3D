...
const { INTERACTION_PAGE_OPTIONS } = await (import.meta.url.startsWith("file:")
  ...
  : import("/static/utils/interaction-pages.js?v=20260921152526"));
...
const {
  ...
  : import("/static/utils/numbers.js?v=20260921152526"));
