 ...
 * `from "../core/static-helpers.js?v=20260920104554"`（同域文件则写 `./static-helpers.js`），
...
const { INTERACTION_PAGE_OPTIONS } = await (import.meta.url.startsWith("file:")
  ...
  : import("/static/utils/interaction-pages.js?v=20260920104554"));
