...
import { createDomFactory } from "./static-helpers.js?v=2609220052";
...
const { cameraPopupLayout: cameraPopupLayout } = await (import.meta.url.startsWith("file:")
  ...
  : import("/static/bridge/camera-popup-layout.js?v=2609220052"));
/**
 * 计算弹窗预览的落位与缩放。
 */
...
export function createFocusDevicePopup(
  ...
  stylesheetLink.href = "/static/renderer/core/renderer.css?v=2609220052";
  ...
  return {
    ...
    ready: (import.meta.url.startsWith("file:")
      ...
      : import("/static/renderer/core/renderer.js?v=2609220052")
