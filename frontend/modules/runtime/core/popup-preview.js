...
const { cameraPopupLayout: cameraPopupLayout } = await (import.meta.url.startsWith("file:")
  ...
  : import("/static/bridge/camera-popup-layout.js?v=20260921090405"));
/**
 * 计算弹窗预览的落位与缩放。
 */
...
export function createFocusDevicePopup(
  ...
  stylesheetLink.href = "/static/renderer/core/renderer.css?v=20260921090405";
  ...
  return {
    ...
    ready: (import.meta.url.startsWith("file:")
      ...
      : import("/static/renderer/core/renderer.js?v=20260921090405")
