...
const { drawTelevisionPoster: drawTelevisionPoster } = await (import.meta.url.startsWith("file:")
  ? import(
      new URL(
        "../../static/3d-studio/studio-television-poster.js?v=20260918175732",
        import.meta.url
      )
    )
  : import("/static/3d-studio/studio-television-poster.js?v=20260918175732"));
...
const { drawTelevisionGlass: drawTelevisionGlass } = await (import.meta.url.startsWith("file:")
  ? import(
      new URL(
        "../../static/3d-studio/studio-television-glass.js?v=20260918175732",
        import.meta.url
      )
    )
  : import("/static/3d-studio/studio-television-glass.js?v=20260918175732"));
/**
 * 创建电视屏幕控制器。
 *
