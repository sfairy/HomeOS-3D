 ...
 */
import { vacuumMapIdentity } from "./vacuum-map.js?v=20260916074544";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=20260916074544";
import { mountInteraction3d } from "./runtime.js?v=20260916074544";
import { lightState } from "./light-state.js?v=20260916074544";
import { openVacuumMapEditor } from "./vacuum-map-editor.js?v=20260916074544";
import { nasGroups } from "./nas-panel.js";
import { randomUuid } from "/static/utils/random-id.js?v=20260916074544";
import { interaction3dPreviewSize } from "/static/modules/interaction3d/preview-layout.js?v=20260916074544";
import {
  requestInteraction3dAccess,
  getInteraction3dEditorView,
  subscribeInteraction3dAccess
} from "/static/modules/interaction3d/bridge.js?v=20260916074544";
import { normalizeInteraction3dLightingMode } from "/static/modules/interaction3d/definition.js?v=20260916074544";
import {
  DEFAULT_BASE_LIGHTING,
  normalizeBaseLighting
} from "/static/3d-studio/studio-normalization.js?v=20260916074544";
import {
  EDITOR_SAVE_STATUS,
  ...
  function renderEffectSettings(containerElement, lightItem, lightCapabilities) {
    ...
    if (
      ...
      for (const [
        ...
        ["默认亮度（%）", "brightness", lightCapabilities.brightnessSupported, 0, 100, 1],
