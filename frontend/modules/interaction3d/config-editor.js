 ...
 */
import { vacuumMapIdentity } from "./vacuum-map.js?v=20260918174425";
import { openInteraction3dRangeEditor } from "./range-dialog.js?v=20260918174425";
import { mountInteraction3d } from "./runtime.js?v=20260918174425";
import { lightState } from "./light-state.js?v=20260918174425";
import { openVacuumMapEditor } from "./vacuum-map-editor.js?v=20260918174425";
import { nasGroups } from "./nas-panel.js";
import { randomUuid } from "/static/utils/random-id.js?v=20260918174425";
import { interaction3dPreviewSize } from "/static/modules/interaction3d/preview-layout.js?v=20260918174425";
import {
  requestInteraction3dAccess,
  getInteraction3dEditorView,
  subscribeInteraction3dAccess
} from "/static/modules/interaction3d/bridge.js?v=20260918174425";
import { normalizeInteraction3dLightingMode } from "/static/modules/interaction3d/definition.js?v=20260918174425";
import {
  DEFAULT_BASE_LIGHTING,
  normalizeBaseLighting
} from "/static/3d-studio/studio-normalization.js?v=20260918174425";
import {
  EDITOR_SAVE_STATUS,
  editorDraftHasChanges,
  serializeEditorDraft
} from "./editor-save-status.js?v=20260918174425";
import { confirmAction } from "/static/ui-confirm.js?v=20260918174425";
...
export async function openInteraction3dEditor({
  ...
  styleSheetLinkElement.href =
    "/api/v1/modules/interaction3d/runtime.css?v=20260918174425";
