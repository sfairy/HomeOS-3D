 ...
 */
import { openPresenceFocusEditor } from "./presence-focus-editor.js?v=20260918202529";
...
import { serializeEditorDraft } from "./editor-save-status.js?v=20260918202529";
/**
 * 打开人在传感器编辑对话框。
 *
...
export async function openPresenceEditor({
  ...
  styleLinkElement.href =
    "/api/v1/modules/interaction3d/presence-editor.css?v=20260918202529";
